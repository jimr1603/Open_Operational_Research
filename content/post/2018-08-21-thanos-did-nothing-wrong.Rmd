...
Of course, this comes out the same as the case when the catastrophe happens at the endof the 100 year appraisal, but it's satisfying to write code that suggests Thanos might not be right on this.
