---
title: Garage Gym Comp Results 2022
author: James Riley
date: '2022-04-07'
...
We have preliminary results for 2022 GGC. [As is tradition, I'm poking the data to see what falls out](https://openor.blog/2021/06/18/garagegym/). 

This might also end up as a demo of RAP - if the final results are basically the same shape I can copy-paste the code. 

```{r}

data = readxl::read_excel("2022_Spring_GGC_DraftResults_V1.xlsx",
                   sheet = 1) %>% 
  janitor::clean_names()
