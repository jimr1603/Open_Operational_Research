...
I was reading one of [Ian Stewart's](link to...) books of popular maths, and I found a potentially incomplete solutuion to a puzzle.
...
binary <- map(binary, transpose) %>%
  ...
  ungroup()
```
Now I can slap these sequences on the words that overscored.
